...
func ExecutePythonSimpleDocker(ctx context.Context, code string, timeout time.Duration) ExecResult {
       ...
       if !isDockerAvailable() {
	       ...
	       return ExecResult{"", errors.New("Docker is not available or not running")}
       }
       ...
       if ctx.Err() == context.DeadlineExceeded {
	       ...
	       return ExecResult{"", errors.New("execution timed out")}
       }
       ...
       if err != nil {
	       ...
	       return ExecResult{output, errors.New("docker execution failed")}
       }
