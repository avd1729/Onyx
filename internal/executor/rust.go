...
func (rs RustExecutor) Execute(
	...
	log.Println(logPrefix, "Preparing to execute Rust code in Docker...")
	...
	if len(dependencies) > 0 {
		log.Println(logPrefix, "Warning: Rust dependencies are not yet supported. Ignoring...")
	}
