...
type RunCodeParams struct {
	Language string `json:"language" jsonschema:"language to run (python only for now)"`
...
func RunCode(ctx context.Context, req *mcp.CallToolRequest, args RunCodeParams) (*mcp.CallToolResult, any, error) {
